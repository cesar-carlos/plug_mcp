...
- Consulta semântica: se buscar_contexto devolver consultaSemanticaSugerida (KPI de agregação com maior overlap da pergunta; empate: IR no pacote, depois definicao; CAST/data não entram; IR órfão e alias de quantidade/NroParc omitidos salvo a pergunta falar de volume; score 0 sem IR certificado omite), prefira consultar_dados.consultaSemantica com esse esqueleto. SQL livre só se faltar elemento certificado. Colunas são qualificadas quando há JOIN.
