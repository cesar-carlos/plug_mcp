...
| [`data/`](data)                 | [data-model.md](data/data-model.md)                                                                                                                                             | Cofre, grafo composto, FTS (`0016`–`0018`), skill v2, aprendizado             |
...
- Consulta ao ERP **só com skill publicada**. A IA escreve SQL **dentro do escopo** (tabela/coluna/JOIN do pacote). `buscar_contexto` não devolve SQL — use `obter_skill`. Sem skill capaz: não inventar; orientar o cadastro.
